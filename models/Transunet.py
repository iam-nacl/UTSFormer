...
class Transformer(nn.Module):
    def __init__(self, config, img_size, vis):
        ...
        self.encoder = Encoder_AOS(config, vis)
...
def TransUnet_Model(pretrained=False, vit_name='R50-ViT-B_16', vit_patches_size=16, num_classes=9, n_skip=3, img_size=256, **kwargs):
...
class Encoder_AOS(nn.Module):
    def __init__(self, config, vis):
        super(Encoder_AOS, self).__init__()
        self.vis = vis
        self.layer = nn.ModuleList()
        self.encoder_norm = LayerNorm(config.hidden_size, eps=1e-6)
        dim = 768
