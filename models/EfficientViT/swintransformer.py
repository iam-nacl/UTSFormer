...
class Transformer_Swin(nn.Module):
    def __init__(self, dim, depth, heads, dim_head, mlp_dim=1024, dropout=0., num_patches=128):
        ...
        self.layers = nn.ModuleList([
            SwinTransformerBlock(dim=dim, input_resolution=(256//16, 256//16),
                                 num_heads=heads, window_size=window_size,
                                 shift_size=0 if (i % 2 == 0) else window_size // 2,
                                 mlp_ratio=4,
                                 qkv_bias=True,
